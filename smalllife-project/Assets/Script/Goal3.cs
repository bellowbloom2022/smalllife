...
public class Goal3 : MonoBehaviour
{
    ...
    public BoxCollider firstCollider => GetComponents<BoxCollider>()[0];
    public BoxCollider secondCollider => GetComponents<BoxCollider>()[1];
    ...
    public void EnableSecondCollider()
    {
        if(secondCollider != null)
        {
            ...
            Debug.Log("第二个BoxCollider已启用");
        }
    }

    public void DisableSecondCollider()
    {
        if(secondCollider != null)
        {
            secondCollider.enabled = false;
            Debug.Log("第二个BoxCollider已禁用");
        }
    }
